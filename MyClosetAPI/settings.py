"""
Django settings for MyClosetAPI project.
...
SECRET_KEY = 'django-insecure-f54!^+z1kq_2+fx1u&5bw2y8*+w$lxz64&7pc5o6liy7nxl@ts'
...
WSGI_APPLICATION = 'MyClosetAPI.wsgi.application'
